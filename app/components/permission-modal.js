...
export default Ember.Component.extend(OperationModal, {
  ...
  permission: Ember.computed('fileSelectionService.files', function() {
    var files = this.get('fileSelectionService.files');
    var selectedFile = files.objectAt(0);
    return selectedFile.get('permission');
  }).readOnly(),
